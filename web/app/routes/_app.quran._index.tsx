  ...
  return (
    <div className='flex flex-col flex-1 p-8 max-w-3xl mx-auto'>
      ...
      <div className='space-y-6'>
        <section>
          <h2 className='text-xl font-medium mb-2'>What is the Quran?</h2>
        ...
        <section>
          <p className='text-gray-700 mb-4'>Some key facts about the Quran:</p>
          <ul className='list-disc pl-6 space-y-2 text-gray-700'>
            ...
            <li>The Quran has been preserved in its original form since its revelation over 1400 years ago, without any additions or deletions to its text.</li>
          </ul>
        </section>

        <section>
          <h2 className='text-xl font-medium mb-2'>Structure</h2>
          <p className='text-gray-700'>
        ...
        <section>
          <h2 className='text-xl font-medium mb-2'>Significance</h2>
          <p className='text-gray-700'>
